...
void set_halo_values_x( real_3d_array_view const &state , Fixed_data const &fixed_data ) {
  ...
  real_3d_container recvbuf_l( NUM_VARS,nz,hs );  //Buffer to receive data from the left MPI rank
  real_3d_container recvbuf_r( NUM_VARS,nz,hs );  //Buffer to receive data from the right MPI rank
  real_3d_container sendbuf_l( NUM_VARS,nz,hs );  //Buffer to send data to the left MPI rank
  real_3d_container sendbuf_r( NUM_VARS,nz,hs );  //Buffer to send data to the right MPI rank
  ////////////////////////////////////////////////////////////
